...
```{r sel4, eval=TRUE, echo=TRUE, fig.cap= "Gillnet master normal selectivity function with different retention parameters.", fig.show="hold", out.width="100%"}
...
```{r sel5, eval=TRUE, echo=TRUE, fig.cap= "Gillnet master log normal selectivity function with different retention parameters.", fig.show="hold", out.width="100%"}
